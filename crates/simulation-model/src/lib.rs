...
pub use entity::{
    ...
    HumanGroupId, HumanGroupInitialState, HumanGroupLineage, HumanGroupRegistry,
    HumanGroupRuntimeSeed, HumanGroupState, InitialKnowledgeProfile, KnowledgeSeedValue,
    KnowledgeStateRef, MemoryStateRef, PoliticalEntity, PoliticalEntityId, PoliticalEntityRegistry,
    RegionId, SettlementEntity, SettlementId, SettlementRegistry, StableEntityId,
};
